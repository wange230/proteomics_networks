...
#APOE33_AD APOE33_NL  APOE4_AD    others 
# 56        35        57        36 
...
table(dff$Groups)
dff$Groups = factor(dff$Groups, levels=c("APOE33_NL","APOE33_AD","APOE4_AD"))
...
head(wdata01)
wdata01$Genotypes = factor(wdata01$Groups, levels = c("APOE33_NL","APOE33_AD","APOE4_AD"))
head(wdata01)
...
p 
pdf(file="DEP_APOE/AHANK_exp_over_APOE_AD_status_by_gender_05_31_2024.pdf", height = 3.5, width = 4.5)
print(p)
dev.off()
...
pp <- ggboxplot(wdata01, x = "Genotypes", y = "AHANK",
  ...
  xlab("") + ylab("AHANK\n (normalized expression)")
pp 
pdf(file="DEP_APOE/AHANK_exp_over_APOE_AD_status_05_31_2024.pdf", height = 4.5, width = 5.0)
print(pp)
dev.off()
