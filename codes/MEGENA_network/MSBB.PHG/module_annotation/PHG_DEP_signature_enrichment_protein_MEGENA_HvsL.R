...
dat <- read.table("Protein_exprCorrected_HvsL_CERAD_final.tsv", sep="\t", stringsAsFactors = FALSE, header = TRUE)
head(dat)
...
write.table(enTable, file = "hyperGeTest_new/EnrichmentTable_Protein_exprCorrected_HvsL_CERAD_final_FC11_vs_PHG_protein_MEGENA_modules.txt",
            sep="\t", row.names = FALSE)
