...
setwd("C:/Users/wange13/Desktop/COHORT_data_06_05_2017/MSBB/PHG_Proteomics/processed/DEProtein_final_11_12_2019")
dat <- read.table("Protein_exprCorrected_HvsL_Braak_final.tsv", sep="\t", stringsAsFactors = FALSE, header = TRUE)
head(dat)
...
source("C:/common_tools_datasets/IGAP_signif_p005/Sig_seperate/astrocyte/geneSetOverLap.R")
size = 23002  #23002, 39579
...
write.table(enTable, file = "hyperGeTest/EnrichmentTable_Protein_exprCorrected_HvsL_Braak_final_FC11_vs_PHG_protein_MEGENA_modules.txt", sep="\t", row.names = FALSE)
