...
outfname <- "TCGA_GCC.vs.TCGA_vGCC9209prot2rnaperm200"
dir.create(out.dir)

load("data_4_msbb.exp.prot9209_and_rosmap.exp.rna.RData")

data.mat <- rosmap.exp.rna
valid.mat <- msbb.exp.prot
...
mol <- read.table("../PHG_MEGENA_module_conservation/for_preservation/MEGENA_MSBB.PHG.proteomics.PMI_Age_race_sex_batch_adj_MEGENA2WGCNA_reformat.tsv", 
