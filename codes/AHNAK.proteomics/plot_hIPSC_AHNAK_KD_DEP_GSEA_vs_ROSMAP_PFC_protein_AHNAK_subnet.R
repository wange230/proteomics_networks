##  GSEA of AHNAK KD DEP in the ROSMAP PFC proteomics MEGENA subnet of AHNAK
rm(list=ls())
...
setwd("C:/Users/wange13/Desktop/ROSMAP.proteomics/output/imputed/MEGENA/MEGENA_subnet")

net00 = read.table("PHG_protein_KDA_subBN_nodes_AHNAK_Q09666_9layers.txt",
                 sep="\t",stringsAsFactors = F, header = T)
head(net00)
net01 = net00 %>% distinct(protein.GN, .keep_all = T)
net01 = net01[,c(7,2)]
head(net01)
